    ...
    <div id="main-area">
      <main class="main-area ibx">
        ...
        <div class="cat-cont-area">
          <section class="pt2">
            <div class="cbx bgi bg1-1"><h2></h2></div>
            <div class="cbx bgi bg1-2"><h2></h2></div>
            <div class="cbx bgi bg1-3"><h2></h2></div>
          </section>  
          <section class="pt2">
            <div class="cbx bgi bg2-1"><h2></h2></div>
            <div class="cbx bgi bg2-2"><h2></h2></div>
            <div class="cbx bgi bg2-3"><h2></h2></div>
          </section>
